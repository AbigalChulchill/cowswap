...
import Row, { /* Row, */ AutoRow /*, RowFixed */, RowBetween } from 'components/Row'
            ...
            <OrderWrapper>
              ...
              */}
                        ...
                        <HighFeeWarning
                          ...
                          acceptWarningCb={
                            !isExpertMode && account ? () => setFeeWarningAccepted((state) => !state) : undefined
                          }
                          width="99%"
                          padding="5px 15px"
                        />
                        <NoImpactWarning
                          ...
                          acceptWarningCb={
                            !isExpertMode && account ? () => setImpactWarningAccepted((state) => !state) : undefined
                          }
                          width="99%"
                          padding="5px 15px"
                        />
                        <BottomGrouping>
                          {swapIsUnsupported ? (
                            ...
                            <GreyCard style={{ textAlign: 'center' }}>
                              <TYPE.main mb="4px">
                                <Trans>
                                  Buying {GpEther.onChain(chainId || SupportedChainId.MAINNET).symbol} with smart
                              ...
                              <AutoColumn style={{ width: '100%' }} gap="12px">
                                        ...
                                        <MouseoverTooltip
                                          text={
                                            <Trans>
                                              ...
                                              {currencies[Field.INPUT]?.symbol}. You only have to do this once per
                                              token.
                                            </Trans>
                                          }
                                        >
                                ...
                                <ButtonError
                                  ...
                                  disabled={
                                    !isValid ||
                                    (approvalState !== ApprovalState.APPROVED &&
                                      signatureState !== UseERC20PermitState.SIGNED) // || priceImpactTooHigh
                                  }
